def writer(file_path,name,id,percentage,data,answers,plagarism_percentage):
    ...
    answers = answers
    plagarism = plagarism_percentage
    
    


    # Zip the questions and answers
    quiz_and_answers = zip(qus, answers)
    ...
    html_content = f"""
        ...
        <head>
        <title> Welcome to SmartGrader </title>
        <!--[if !mso]><!-- -->
        ...
        <div style="background-color:#f3f3f5;">
                ...
                <![endif]-->
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        ...
                        <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:20px;font-weight:300;line-height:30px;text-align:left;color:#003366;">
                                <p style="margin: 0;"> Your id number is {id}. Your score is {percentage}, which indicates {percentage} performance. Additionally, your answer sheet contains {plagarism} plagarism count. Should your plagiarism count exceed 20%, it would constitute a violation of our policy, leading to necessary actions being taken. </p>
                            </div>
                            </td>
                        </tr>
                        </table>
                    ...
                    <td
                    class="" style="vertical-align:top;width:290px;"
                    >
                <![endif]-->
                ...
                <![endif]-->
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        ...
                        <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Poppins, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                <tr>
                                <th colspan="3" style="font-weight: 500; color: #003366; text-align: center; border-bottom: 2px solid #d5d5d5; font-size: 18px; line-height: 26px; padding: 10px;" align="center">Your Marks </th>
                                </tr>
                                <tr>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; width: 60%; padding-top: 10px;" width="60%"> Marks </td>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; text-align: right; width: 20%;" width="20%" align="right">{percentage}</td>
                                
                                </tr>
                                <tr>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; border-bottom-width: 1px; border-bottom-color: #d5d5d5; border-bottom-style: solid; padding-top: 10px;"></td>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; border-bottom-width: 1px; border-bottom-color: #d5d5d5; border-bottom-style: solid; padding-top: 10px;"></td>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; border-bottom-width: 1px; border-bottom-color: #d5d5d5; border-bottom-style: solid; padding-top: 10px;"></td>
                                </tr>
                                <tr>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; padding: 10px 0; text-align: left;" colspan="2" align="left">Plagarism Count</td>
                                <td style="color: #003366; font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; padding: 10px 0; text-align: right;" align="right">{plagarism}</td>
                                </tr>
                                <tr>
                                <td style="color: #003366; word-break: normal; font-size: 20px; line-height: 30px; border-top: 1px solid #d5d5d5; font-weight: 500; padding: 10px 0px 0px 0px; text-align: left;" colspan="2" align="left">Total Marks</td>
                                <td style="color: #003366; word-break: normal; font-size: 20px; line-height: 30px; border-top: 1px solid #d5d5d5; font-weight: 500; text-align: right; padding: 10px 0px 0px 0px;" align="right">{percentage}</td>
                                </tr>
                            </table>
                            </td>
                        </tr>
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        ...
                        <tr>
                            ...
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#043768;">
                                <p style="margin: 0;">You're receiving this email because you upload a assignment at SmartGrader. If you have any questions, contact us at <a href="#" style="color: #00AD55; text-decoration: none; word-break: normal;">h.h.a.r.p.premachandra@gmail.com</a></p>
                            </div>
                            </td>
                        </tr>
                        </table>
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        ...
                        <tr>
                            ...
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:16px;font-weight:500;line-height:30px;text-align:left;color:#ffffff;">
                                <p style="margin: 0;"> 076-1234567 </p>
                            </div>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:16px;font-weight:500;line-height:30px;text-align:left;color:#ffffff;">
                                <p style="margin: 0;"> Copyright © 2024 SmartGrader<br> All rights reserved.</p>
                            </div>
                            </td>
                        </tr>
                        </table>
            ...
            <![endif]-->
                        ...
                        <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:16px;font-weight:500;line-height:30px;text-align:left;color:#ffffff;">Thanks <a class="footer-link" href="https://google.com" style="word-break: normal; color: #fff; text-decoration: underline;">for your <a class="footer-link" href="" style="word-break: normal; color: #fff; text-decoration: underline;"> valuable </a>Time</div>
                            </td>
                        </tr>
                        </table>
                    </div>
